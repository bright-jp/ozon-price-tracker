"""
Ozon Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Ozon.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/ozon
"""
...
# Set your Web Scraper ID after building your Ozon scraper:
# https://brightdata.jp/products/web-scraper/ozon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Ozon scraper at: https://brightdata.jp/products/web-scraper/ozon\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Ozon product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Ozon products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Ozon category page.

    Example:
        results = discover_by_category("https://ozon.ru/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.ozon.ru/product/sample-item-123456",
        # Add more Ozon product URLs here
    ]
    ...
    # cat_results = discover_by_category("https://ozon.ru/category/sample", limit=50)
